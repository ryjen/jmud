...
public class SoftFont {
	...
	/* 00011000 */
									 ...
									 * BOX DRAWINGS VERTICAL SINGLE AND RIGHT
									 * DOUBLE
									 */
	...
	/* 00011000 */
									 ...
									 * BOX DRAWINGS VERTICAL DOUBLE AND RIGHT
									 * SINGLE
									 */
	...
	/* 00110110 */
									 ...
									 * BOX DRAWINGS UP SINGLE AND HORIZONTAL
									 * DOUBLE
									 */
	...
	public boolean inSoftFont(char c) {
		...
		if (!insoftfont && c >= 0x100) {
			LoggerFactory.getLogger(SoftFont.class).error(
					"Character " + ((int) c) + " not in softfont");
		}
		return insoftfont;
	}
}
